"use strict";var YuktAI=(()=>{var E=Object.defineProperty;var P=Object.getOwnPropertyDescriptor;var I=Object.getOwnPropertyNames;var j=Object.prototype.hasOwnProperty;var K=(t,i)=>{for(var n in i)E(t,n,{get:i[n],enumerable:!0})},O=(t,i,n,s)=>{if(i&&typeof i=="object"||typeof i=="function")for(let a of I(i))!j.call(t,a)&&a!==n&&E(t,a,{get:()=>i[a],enumerable:!(s=P(i,a))||s.enumerable});return t};var G=t=>O(E({},"__esModule",{value:!0}),t);var re={};K(re,{wcagPlugin:()=>ae});var w=null,C=null,A=null,$=null,T=null,b=null,m=null,h=null,S=null,g=null,k={deuteranopia:"yuktai-cb-d",protanopia:"yuktai-cb-p",tritanopia:"yuktai-cb-t"},H=new Set(["h1","h2","h3","h4","h5","h6"]),q=new Set(["input","select","textarea"]),W=new Set(["button","a","input","select","textarea","details","summary"]),V=new Set(["video","audio"]),Y=new Set(["ul","ol","dl"]);var L={nav:"navigation",header:"banner",footer:"contentinfo",main:"main",aside:"complementary"};function M(t,i="polite"){if(typeof window>"u"||!g?.speechEnabled||!window.speechSynthesis)return;window.speechSynthesis.cancel();let n=new SpeechSynthesisUtterance(t);n.rate=1,n.pitch=1,n.volume=1;let s=window.speechSynthesis.getVoices();s.length>0&&(n.voice=s[0]),window.speechSynthesis.speak(n)}function R(t,i="info"){if(typeof document>"u")return;let s={success:{bg:"#0f9d58",border:"#0a7a44",icon:"\u2713"},error:{bg:"#d93025",border:"#b52a1c",icon:"\u2715"},warning:{bg:"#f29900",border:"#c67c00",icon:"\u26A0"},info:{bg:"#1a73e8",border:"#1557b0",icon:"\u2139"}}[i];b||(b=document.createElement("div"),b.setAttribute("role","alert"),b.setAttribute("aria-live","assertive"),b.setAttribute("aria-atomic","true"),b.style.cssText=`
    ...
    `,document.body.appendChild(b)),b.style.background=s.bg,b.style.border=`1px solid ${s.border}`,b.style.color="#fff",b.innerHTML=`
  ...
  `,requestAnimationFrame(()=>{b&&(b.style.transform="translateX(0)",b.style.opacity="1")}),setTimeout(()=>{b&&(b.style.transform="translateX(120%)",b.style.opacity="0")},5e3)}function c(t,i="info",n=!0){w&&(w.textContent=t),R(t,i),n&&M(t,i==="error"?"assertive":"polite")}function U(){if(typeof document>"u"||$)return;let t=[{label:"Skip to main content",selector:"main,[role='main'],#main,#main-content"},{label:"Skip to navigation",selector:"nav,[role='navigation'],#nav,#navigation"},{label:"Skip to search",selector:"[role='search'],#search,input[type='search']"}],i=document.createElement("div");i.setAttribute("data-yuktai-skip-bar","true"),i.setAttribute("role","navigation"),i.setAttribute("aria-label","Skip links"),i.style.cssText=`
  ...
  `,t.querySelector("[data-yuktai-close]")?.addEventListener("click",()=>{t.remove(),m=null}),t.addEventListener("keydown",s=>{s.key==="Escape"&&(t.remove(),m=null)}),document.body.appendChild(t),m=t,y(t),c("Keyboard shortcuts opened. Press Escape to close.","info")}function Z(t){if(typeof document>"u"||!g?.showAuditBadge||typeof window<"u"&&!window.location.hostname.includes("localhost")&&!window.location.hostname.includes("127.0.0.1"))return;T&&T.remove();let i=t.score,n=i>=90?"#0f9d58":i>=70?"#f29900":"#d93025",s=i>=90?"\u267F":i>=70?"\u26A0":"\u2715",a=document.createElement("button");a.setAttribute("aria-label",`Accessibility score: ${i} out of 100. Click for details.`),a.setAttribute("data-yuktai-badge","true"),a.style.cssText=`
  ...
  `,a.innerHTML=`${s} ${i}/100 <span style="font-weight:400;opacity:0.85">${t.details.length} issues</span>`,a.addEventListener("mouseenter",()=>{a.style.transform="scale(1.05)"}),a.addEventListener("mouseleave",()=>{a.style.transform="scale(1)"}),a.addEventListener("click",()=>{Q(t)}),document.body.appendChild(a),T=a}function Q(t){let i=document.querySelector("[data-yuktai-audit-details]");if(i){i.remove();return}let n=document.createElement("div");n.setAttribute("data-yuktai-audit-details","true"),n.setAttribute("role","dialog"),n.setAttribute("aria-label","Accessibility audit details"),n.style.cssText=`
  ...
  `,n.addEventListener("keydown",a=>{a.key==="Escape"&&n.remove()}),document.body.appendChild(n),y(n)}function _(t){typeof document>"u"||(S&&clearTimeout(S),S=setTimeout(()=>{if(h)return;let i=document.createElement("div");i.setAttribute("role","alertdialog"),i.setAttribute("aria-label","Session timeout warning"),i.setAttribute("aria-modal","true"),i.setAttribute("data-yuktai-timeout","true"),i.style.cssText=`
    ...
    `;let n=i.querySelector("[data-yuktai-extend]"),s=i.querySelector("[data-yuktai-dismiss]");n?.addEventListener("click",()=>{i.remove(),h=null,c("Session extended. You have more time.","success"),g?.timeoutWarning&&_(g.timeoutWarning)}),s?.addEventListener("click",()=>{i.remove(),h=null}),document.body.appendChild(i),h=i,y(i),c("Warning: Your session will expire soon. Do you need more time?","warning")},t*1e3))}function F(t){if(typeof document>"u"||A)return;try{let a=localStorage.getItem("yuktai-a11y-prefs");if(a){let l=JSON.parse(a);Object.assign(t,l),x(t)}}catch{}let i=document.createElement("button");i.setAttribute("aria-label","Accessibility preferences"),i.setAttribute("aria-haspopup","dialog"),i.setAttribute("data-yuktai-pref-toggle","true"),i.style.cssText=`
            ...
            <label style="display:flex;align-items:center;justify-content:space-between;padding:6px 0;cursor:pointer;gap:8px">
              ...
              ${l.type==="toggle"?`
                <div data-yuktai-toggle="${l.key}" style="
                  ...
                  background:${v(t,l.key)?"#1a73e8":"#ccc"};
                  position:relative;cursor:pointer;transition:background 0.2s;flex-shrink:0;
                ">
                  <div style="
                    position:absolute;top:2px;left:${v(t,l.key)?"20px":"2px"};
  ...
  `,n.querySelectorAll("[data-yuktai-toggle]").forEach(a=>{a.addEventListener("click",()=>{let l=a.getAttribute("data-yuktai-toggle");t[l]=!v(t,l),B(t),x(t),z(t),c(`${l.replace(/([A-Z])/g," $1")} ${v(t,l)?"enabled":"disabled"}`,"info")})}),n.querySelectorAll("input[type='radio']").forEach(a=>{a.addEventListener("change",()=>{let l=a.value.replace("colorBlind_","");t.colorBlindMode=l,B(t),x(t),c(`Colour blind mode: ${l}`,"info")})}),n.querySelector("[data-yuktai-show-keys]")?.addEventListener("click",()=>{N()}),n.querySelector("[data-yuktai-reset]")?.addEventListener("click",()=>{localStorage.removeItem("yuktai-a11y-prefs"),t.highContrast=!1,t.darkMode=!1,t.reduceMotion=!1,t.largeTargets=!1,t.speechEnabled=!1,t.colorBlindMode="none",x(t),z(t),c("Preferences reset to default","info")}),n.querySelector("[data-yuktai-panel-close]")?.addEventListener("click",()=>{n.style.display="none",i.focus(),c("Preferences closed","info")}),n.addEventListener("keydown",a=>{a.key==="Escape"&&(n.style.display="none",i.focus())}),i.addEventListener("click",()=>{let a=n.style.display!=="none";n.style.display=a?"none":"block",i.setAttribute("aria-expanded",String(!a)),a||(y(n),c("Accessibility preferences opened","info"))}),document.body.appendChild(i),document.body.appendChild(n),A=n}function z(t){A&&(A.remove(),A=null),F(t)}function v(t,i){return!!t[i]}function ee(t,i){let n=i.replace("colorBlind_","");return t.colorBlindMode===n}function B(t){try{let i={highContrast:t.highContrast,darkMode:t.darkMode,reduceMotion:t.reduceMotion,largeTargets:t.largeTargets,speechEnabled:t.speechEnabled,colorBlindMode:t.colorBlindMode};localStorage.setItem("yuktai-a11y-prefs",JSON.stringify(i))}catch{}}function x(t){if(typeof document>"u")return;let i=document.documentElement;i.toggleAttribute("data-yuktai-high-contrast",!!t.highContrast),i.toggleAttribute("data-yuktai-dark",!!t.darkMode),i.toggleAttribute("data-yuktai-reduce-motion",!!t.reduceMotion),i.toggleAttribute("data-yuktai-large-targets",!!t.largeTargets),i.toggleAttribute("data-yuktai-keyboard",!!t.keyboardHints);let n=document.body;if(t.colorBlindMode&&t.colorBlindMode!=="none"){let s=t.colorBlindMode==="achromatopsia"?"grayscale(100%)":`url(#${k[t.colorBlindMode]})`;n.style.filter=s}else n.style.filter=""}function te(){if(typeof document>"u"||w)return;let t=document.createElement("div");t.setAttribute("aria-live","polite"),t.setAttribute("aria-atomic","true"),t.setAttribute("aria-relevant","text"),t.style.cssText="position:absolute;left:-9999px;width:1px;height:1px;overflow:hidden;clip:rect(0,0,0,0);",document.body.appendChild(t),w=t}function ie(){if(typeof document>"u"||C)return;let t=document.createElementNS("http://www.w3.org/2000/svg","svg");t.setAttribute("aria-hidden","true"),t.style.cssText="position:absolute;width:0;height:0;overflow:hidden;",t.innerHTML=`
    <defs>
